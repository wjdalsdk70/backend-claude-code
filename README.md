...
| `patterns/controller-patterns` | `*Controller.java` |
| `patterns/dto-patterns` | `*Dtos.java` |
| `patterns/entity-patterns` | `*Entity.java`, `domain/**` |
| `patterns/repository-patterns` | `*Repository*.java` |
| `patterns/service-patterns` | `*Service.java` |
